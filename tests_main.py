...
if __name__ == '__main__':
    ...
    csv_overall_name = 'colistemato_overall_2024_02_21.csv'
    csv_statistics_name = 'colistemato_statistics_2024_02_21.csv'
    ...
    try:
        ...
        write_into_csv(('P deviation', 'P average', 'P median', 'D deviation', 'D average', 'D median', 'A deviation', 'A average', 'A median'), csv_statistics_name)
    ...
    write_into_csv((p_deviation, p_average, p_median, d_deviation, d_average, d_median, a_deviation, a_average, a_median), csv_statistics_name)
